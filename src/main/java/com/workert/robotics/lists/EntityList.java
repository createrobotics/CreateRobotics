...
public class EntityList {
	...
	public static final EntityEntry<Miner> MINER = Robotics.REGISTRATE.entity("miner",
					Miner::new, MobCategory.MISC).lang("Miner").properties(properties -> properties.sized(1.2f, 1.8f))
			.attributes(
	...
	public static final EntityEntry<CodeDrone> CODE_DRONE = Robotics.REGISTRATE.entity("code_drone",
					CodeDrone::new, MobCategory.MISC).lang("Juan").properties(properties -> properties.sized(1f, 0.4f))
			.attributes(
					() -> Mob.createMobAttributes().add(Attributes.MOVEMENT_SPEED, 0.2F)
							.add(Attributes.MAX_HEALTH, 1.0D)
