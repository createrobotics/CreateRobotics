...
public class ModConfiguredFeatures {
	public static final DeferredRegister<ConfiguredFeature<?, ?>> CONFIGURED_FEATURES =
			DeferredRegister.create(Registry.CONFIGURED_FEATURE_REGISTRY, Robotics.MOD_ID);
	public static final Supplier<List<OreConfiguration.TargetBlockState>> OVERWORLD_TIN_ORES = Suppliers.memoize(() -> List.of(
			...
			OreConfiguration.target(OreFeatures.DEEPSLATE_ORE_REPLACEABLES, BlockList.DEEPSLATE_TIN_ORE.get().defaultBlockState())));
