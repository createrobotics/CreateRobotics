...
public class DataLinkTargetHandler {
	...
	public static void rightClickBlock(PlayerInteractEvent.RightClickBlock event) {
		...
		if (!(event.getLevel()
				.getBlockEntity(event.getPos()) instanceof InputBlockEntity)) {
	...
	public static void tick() {
		...
		if (!(heldItem.getItem() instanceof DataLinkBlockItem)) {
			currentItem = null;
		} else {
	...
	private static void checkForWrench(ItemStack heldItem) {
		...
		// TODO: Change this to datalink block entity
