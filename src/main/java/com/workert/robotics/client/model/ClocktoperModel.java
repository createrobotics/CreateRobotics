...
public class ClocktoperModel<T extends Clocktoper> extends EntityModel<T> {

	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation(Robotics.MOD_ID, "clocktoper"), "clocktoper");
	private final ModelPart main;

	public ClocktoperModel(ModelPart root) {
