...
public class ClockcopterModel<T extends Clockcopter> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition propellerBase = body.addOrReplaceChild("propellerBase",
		...
		PartDefinition cube_r1 = gear0
				.addOrReplaceChild("cube_r1",
						CubeListBuilder.create().texOffs(29, 26).addBox(-1.0F, -0.5F, -3.5F, 2.0F, 1.0F, 7.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.8727F, 0.0F, 0.0F));

		PartDefinition cube_r2 = gear0
				.addOrReplaceChild("cube_r2",
						CubeListBuilder.create().texOffs(29, 26).addBox(-1.0F, -0.5F, -3.5F, 2.0F, 1.0F, 7.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 1.5708F, 0.0F, 0.0F));

		PartDefinition cube_r3 = gear0
		...
		PartDefinition cube_r4 = gear1
				.addOrReplaceChild("cube_r4",
						CubeListBuilder.create().texOffs(29, 26).addBox(-1.0F, -0.5F, -3.5F, 2.0F, 1.0F, 7.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.8727F, 0.0F, 0.0F));

		PartDefinition cube_r5 = gear1
				.addOrReplaceChild("cube_r5",
						CubeListBuilder.create().texOffs(29, 26).addBox(-1.0F, -0.5F, -3.5F, 2.0F, 1.0F, 7.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 1.5708F, 0.0F, 0.0F));

		PartDefinition cube_r6 = gear1
		...
		PartDefinition axis2 = arm0.addOrReplaceChild("axis2", CubeListBuilder.create().texOffs(0, 31).addBox(-2.0F,
				-0.5F, -0.5F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.1F)), PartPose.offset(-0.5F, 0.0F, 0.0F));
		...
		PartDefinition ClawConnector_r1 = arm2.addOrReplaceChild("ClawConnector_r1",
				CubeListBuilder.create().texOffs(16, 32)
						...
						.mirror(false),
				PartPose.offsetAndRotation(0.015F, -2.9328F, -0.0106F, -0.5672F, 0.0F, 0.0F));
		...
		PartDefinition ConnectorR_r1 = arm2.addOrReplaceChild("ConnectorR_r1",
				CubeListBuilder.create().texOffs(40, 26).addBox(-1.0F, 0.0F, -3.0F, 1.0F, 1.0F, 6.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.985F, 3.1115F, 8.4795F, -0.7854F, 0.0F, 0.0F));

		PartDefinition LowerBody_r1 = arm2.addOrReplaceChild("LowerBody_r1",
				CubeListBuilder.create().texOffs(39, 0).addBox(-2.0F, -2.5F, -1.5F, 4.0F, 5.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition ClawTop_r1 = down2.addOrReplaceChild("ClawTop_r1",
				CubeListBuilder.create().texOffs(11, 38).addBox(-1.53F, -4.039F, -4.5027F, 3.0F, 1.0F, 5.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition ClawBottom_r1 = up2.addOrReplaceChild("ClawBottom_r1",
				CubeListBuilder.create().texOffs(11, 38).addBox(-1.53F, 0.8992F, -5.6979F, 3.0F, 1.0F, 5.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition axis1 = arm1.addOrReplaceChild("axis1", CubeListBuilder.create().texOffs(0, 31).addBox(-2.0F,
				-0.5F, -0.5F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.1F)), PartPose.offset(0.5F, 0.0F, 0.0F));
		...
		PartDefinition ConnectorR_r2 = arm.addOrReplaceChild("ConnectorR_r2",
				CubeListBuilder.create().texOffs(40, 26).addBox(-1.0F, 0.0F, -3.0F, 1.0F, 1.0F, 6.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.985F, 3.2815F, 8.6295F, -0.7854F, 0.0F, 0.0F));

		PartDefinition LowerBody_r2 = arm.addOrReplaceChild("LowerBody_r2",
				CubeListBuilder.create().texOffs(39, 0).addBox(-1.9F, -2.5F, -0.5F, 4.0F, 5.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition ClawTop_r2 = down.addOrReplaceChild("ClawTop_r2",
				CubeListBuilder.create().texOffs(11, 38).addBox(-1.53F, -4.039F, -7.0027F, 3.0F, 1.0F, 5.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition ClawBottom_r2 = up.addOrReplaceChild("ClawBottom_r2",
				CubeListBuilder.create().texOffs(11, 38).addBox(-1.53F, 0.8992F, -5.9979F, 3.0F, 1.0F, 5.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.03F, -1.3992F, 3.4979F, -0.2618F, 0.0F, 0.0F));

		PartDefinition propeller = partdefinition.addOrReplaceChild("propeller",
		...
		PartDefinition Blade2_r1 = propeller.addOrReplaceChild("Blade2_r1",
				CubeListBuilder.create().texOffs(0, 26).addBox(-1.5F, -0.5F, -5.0F, 3.0F, 1.0F, 10.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(6.5F, -3.5F, 0.0F, 0.0F, -1.5708F, 0.0F));

		PartDefinition Blade1_r1 = propeller.addOrReplaceChild("Blade1_r1",
				CubeListBuilder.create().texOffs(0, 26).addBox(-1.5F, -0.5F, -5.0F, 3.0F, 1.0F, 10.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -3.5F, 6.5F, -3.1416F, 0.0F, 3.1416F));

		PartDefinition Blade3_r1 = propeller.addOrReplaceChild("Blade3_r1",
				CubeListBuilder.create().texOffs(0, 26).addBox(-1.5F, -0.5F, -5.0F, 3.0F, 1.0F, 10.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-6.5F, -3.5F, 0.0F, 0.0F, 1.5708F, 0.0F));
