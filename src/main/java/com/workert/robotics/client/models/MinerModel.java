...
public class MinerModel<T extends Miner> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition base = body.addOrReplaceChild("base",
		...
		PartDefinition cube_r1 = base.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(39, 48).addBox(-9.0F, -1.4F, -1.5F, 18.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -23.8F, 6.95F, 0.6545F, 0.0F, 0.0F));

		PartDefinition cube_r2 = base.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(61, 34).addBox(-6.0F, 9.9F, 13.7F, 12.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r3 = base.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(0, 48).addBox(-9.0F, -1.3F, -0.05F, 18.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -23.5F, -6.5F, -0.6545F, 0.0F, 0.0F));

		PartDefinition cube_r4 = base.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(62, 52).addBox(-0.04F, -6.5359F, 6.6604F, 12.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r5 = axis.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(36, 52).addBox(-1.5953F, -10.8056F, 30.9968F, 6.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r6 = foot.addOrReplaceChild("cube_r6",
		...
		PartDefinition cube_r8 = up.addOrReplaceChild("cube_r8",
				CubeListBuilder.create().texOffs(0, 0)
		...
		PartDefinition cube_r9 = up.addOrReplaceChild("cube_r9",
				CubeListBuilder.create().texOffs(65, 62).addBox(-2.5F, -4.0F, -2.0F, 5.0F, 8.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-16.0942F, -19.25F, -53.4283F, -3.1416F, 0.7854F, 3.1416F));

		PartDefinition cog = leg1.addOrReplaceChild("cog",
		...
		PartDefinition cube_r10 = cog.addOrReplaceChild("cube_r10",
				CubeListBuilder.create().texOffs(62, 56).addBox(-1.75F, -0.5F, -32.5F, 3.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(29.0F, -0.55F, -4.23F, 0.0F, 0.0F, -0.7854F));

		PartDefinition cube_r11 = cog.addOrReplaceChild("cube_r11",
				CubeListBuilder.create().texOffs(62, 56).addBox(-1.75F, -0.5F, -32.5F, 3.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(29.0F, -0.55F, -4.23F, 0.0F, 0.0F, 1.5708F));

		PartDefinition cube_r12 = cog.addOrReplaceChild("cube_r12",
				CubeListBuilder.create().texOffs(62, 56).addBox(-1.75F, -0.5F, -32.5F, 3.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(29.0F, -0.55F, -4.23F, 0.0F, 0.0F, 0.7854F));
		...
		PartDefinition cube_r13 = up2.addOrReplaceChild("cube_r13",
				CubeListBuilder.create().texOffs(65, 62).addBox(-14.5F, -4.0F, -2.0F, 5.0F, 8.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-16.0942F, -19.25F, -53.4283F, -3.1416F, 0.7854F, 3.1416F));

		PartDefinition cube_r14 = up2.addOrReplaceChild("cube_r14",
				CubeListBuilder.create().texOffs(0, 0)
		...
		PartDefinition cube_r15 = foot2.addOrReplaceChild("cube_r15",
				CubeListBuilder.create().texOffs(8, 0)
		...
		PartDefinition cube_r17 = axis2.addOrReplaceChild("cube_r17",
				CubeListBuilder.create().texOffs(36, 52).addBox(-1.5953F, -10.8056F, 18.9968F, 6.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(6.2767F, -11.9444F, -30.5438F, -3.1416F, -0.7854F, 3.1416F));

		PartDefinition cog2 = leg2.addOrReplaceChild("cog2",
				CubeListBuilder.create().texOffs(62, 56)
		...
		PartDefinition cube_r18 = cog2.addOrReplaceChild("cube_r18",
				CubeListBuilder.create().texOffs(62, 56).addBox(-1.75F, -0.5F, -20.5F, 3.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(29.0F, -0.55F, -4.23F, 0.0F, 0.0F, -0.7854F));

		PartDefinition cube_r19 = cog2.addOrReplaceChild("cube_r19",
				CubeListBuilder.create().texOffs(62, 56).addBox(-1.75F, -0.5F, -20.5F, 3.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(29.0F, -0.55F, -4.23F, 0.0F, 0.0F, 1.5708F));

		PartDefinition cube_r20 = cog2.addOrReplaceChild("cube_r20",
				CubeListBuilder.create().texOffs(62, 56).addBox(-1.75F, -0.5F, -20.5F, 3.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(29.0F, -0.55F, -4.23F, 0.0F, 0.0F, 0.7854F));
		...
		PartDefinition cube_r21 = axis3.addOrReplaceChild("cube_r21",
				CubeListBuilder.create().texOffs(36, 52).addBox(-1.5953F, -10.8056F, 30.9968F, 6.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(6.2767F, -11.9444F, -30.5438F, -3.1416F, -0.7854F, 3.1416F));
		...
		PartDefinition cube_r22 = up3.addOrReplaceChild("cube_r22",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(32.4004F, -3.3056F, -0.2369F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(30.4004F, -3.3056F, -0.2369F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(6.2767F, -11.9444F, -30.5438F, -3.1416F, 0.7854F, 3.1416F));

		PartDefinition cube_r23 = up3.addOrReplaceChild("cube_r23",
				CubeListBuilder.create().texOffs(65, 62).addBox(-2.5F, -4.0F, -2.0F, 5.0F, 8.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-16.0942F, -19.25F, -53.4283F, -3.1416F, 0.7854F, 3.1416F));
		...
		PartDefinition cube_r24 = foot3.addOrReplaceChild("cube_r24",
				CubeListBuilder.create().texOffs(8, 0)
						.addBox(32.4004F, -3.3056F, -0.2369F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(8, 0)
						.addBox(30.4004F, -3.3056F, -0.2369F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(6.2767F, -10.9444F, -30.5438F, -3.1416F, 0.7854F, 3.1416F));
		...
		PartDefinition cog3 = leg3.addOrReplaceChild("cog3",
				CubeListBuilder.create().texOffs(62, 56)
						.addBox(27.25F, -1.05F, -36.73F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(91, 41)
						.addBox(28.55F, -1.05F, -38.03F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-59.3982F, -7.55F, 11.215F, 0.0F, -0.7854F, 0.0F));

		PartDefinition cube_r26 = cog3.addOrReplaceChild("cube_r26",
				CubeListBuilder.create().texOffs(62, 56).addBox(-1.75F, -0.5F, -32.5F, 3.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(29.0F, -0.55F, -4.23F, 0.0F, 0.0F, -0.7854F));

		PartDefinition cube_r27 = cog3.addOrReplaceChild("cube_r27",
				CubeListBuilder.create().texOffs(62, 56).addBox(-1.75F, -0.5F, -32.5F, 3.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(29.0F, -0.55F, -4.23F, 0.0F, 0.0F, 1.5708F));

		PartDefinition cube_r28 = cog3.addOrReplaceChild("cube_r28",
				CubeListBuilder.create().texOffs(62, 56).addBox(-1.75F, -0.5F, -32.5F, 3.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(29.0F, -0.55F, -4.23F, 0.0F, 0.0F, 0.7854F));
		...
		PartDefinition cube_r29 = axis4.addOrReplaceChild("cube_r29",
				CubeListBuilder.create().texOffs(36, 52).addBox(-1.5953F, -10.8056F, 30.9968F, 6.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(6.2767F, -11.9444F, -30.5438F, -3.1416F, -0.7854F, 3.1416F));
		...
		PartDefinition cube_r31 = foot4.addOrReplaceChild("cube_r31",
				CubeListBuilder.create().texOffs(8, 0)
						.addBox(32.4004F, -3.3056F, -0.2369F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(8, 0)
						.addBox(30.4004F, -3.3056F, -0.2369F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(6.2767F, -10.9444F, -30.5438F, -3.1416F, 0.7854F, 3.1416F));
		...
		PartDefinition cube_r32 = up4.addOrReplaceChild("cube_r32",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(32.4004F, -3.3056F, -0.2369F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(30.4004F, -3.3056F, -0.2369F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(6.2767F, -11.9444F, -30.5438F, -3.1416F, 0.7854F, 3.1416F));

		PartDefinition cube_r33 = up4.addOrReplaceChild("cube_r33",
				CubeListBuilder.create().texOffs(65, 62).addBox(-2.5F, -4.0F, -2.0F, 5.0F, 8.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-16.0942F, -19.25F, -53.4283F, -3.1416F, 0.7854F, 3.1416F));

		PartDefinition cog4 = leg4.addOrReplaceChild("cog4",
				CubeListBuilder.create().texOffs(62, 56)
						.addBox(27.25F, -1.05F, -36.73F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(91, 41)
						.addBox(28.55F, -1.05F, -38.03F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-59.3982F, -7.55F, 11.215F, 0.0F, -0.7854F, 0.0F));

		PartDefinition cube_r34 = cog4.addOrReplaceChild("cube_r34",
				CubeListBuilder.create().texOffs(62, 56).addBox(-1.75F, -0.5F, -32.5F, 3.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(29.0F, -0.55F, -4.23F, 0.0F, 0.0F, -0.7854F));

		PartDefinition cube_r35 = cog4.addOrReplaceChild("cube_r35",
				CubeListBuilder.create().texOffs(62, 56).addBox(-1.75F, -0.5F, -32.5F, 3.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(29.0F, -0.55F, -4.23F, 0.0F, 0.0F, 1.5708F));

		PartDefinition cube_r36 = cog4.addOrReplaceChild("cube_r36",
				CubeListBuilder.create().texOffs(62, 56).addBox(-1.75F, -0.5F, -32.5F, 3.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(29.0F, -0.55F, -4.23F, 0.0F, 0.0F, 0.7854F));
